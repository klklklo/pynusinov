...
class Euvt2021:
    ...
    def _get_nlam(self, lac):
        ...
        :param lac: single value or list of flux values in lac unit (1 lac = 1 * 10^15 photons * m^-2 * s^-1).
    ...
    def get_spectral_bands(self, lac):
        ...
        of the spectrum of the interval 10-105 nm.
        :param lac: single value or list of flux value in lac unit (1 lac = 1 * 10^15 photons * m^-2 * s^-1)s.
