...
class Euvn1984:
    ...
    def __init__(self):
        self._bands_coeffs, self._lines_coeffs, self._full_coeffs = _m.get_euvn1984_coeffs()
    ...
    class HeI1984:
        ...
        def predict(f107, t):
            ...
            hei = np.array((0.725 + 0.160 * np.power(fb - 60, 2. / 3) +
                            0.0592 * np.power(f107 - fb, 2. / 3)) * 1.e4 * 1e9)

            return hei.item() if f107.size == 1 else hei.ravel()
